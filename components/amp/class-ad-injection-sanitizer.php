...
class Ad_Injection_Sanitizer extends AMP_Base_Sanitizer {
	...
	private function are_ads_disabled() {
		...
		$disable_all = get_post_meta( get_the_ID(), 'adthrive_ads_disable' );
		...
		return isset( $disable_all[0] ) || in_array( 'noads', $tag_names, true ) || $disable_category || $disable_tag || $disable_email;
	}
