 ...
 * License: GPL2
 *
 * Copyright (c) AdThrive LLC 2014-2020
 *
...
define( 'ADTHRIVE_ADS_VERSION', '1.0.40' );
...
function adthrive_ads_php_notice() {
	...
	echo '<div class="error"><p>' . __( 'AdThrive Ads requires PHP 5.6+ and WordPress 4.6+', 'adthrive-ads' ) . '</p></div>';
